  "use client";
import LowStockCard from "@/components/shopping/low-stock-card"
...
import { useEffect } from "react"
  export default function BelanjaPage() {
    ...
    const addToList = (name: string, qty: number=0, unit :string= "") => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-green-50 via-lime-50 to-white">
        ...
        <main className="container mx-auto px-4 py-8 space-y-8">
         ...
         <LowStockCard addToList={addToList} />
              ...
              {recommendedFromRecipe.map((item, i) => (
                ...
                >
                  ...
                  <Button
                   ...
                   onClick={() => addToList(item.name, Number(item.qty), item.unit)}
                  >
                    Tambah
                  </Button>
                </div>
